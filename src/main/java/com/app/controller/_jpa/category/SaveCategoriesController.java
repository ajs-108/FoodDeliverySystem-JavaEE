package com.app.controller._jpa.category;
...
@WebServlet(name = "save-categories", value = "/save-categories")
public class SaveCategoriesController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            jpaCategoryServices.save(categoryDTOList);

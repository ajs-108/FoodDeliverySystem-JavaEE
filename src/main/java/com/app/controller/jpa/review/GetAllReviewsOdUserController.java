...
@WebServlet(name = "get-all-reviews-of-user", value = "/get-all-reviews-of-user")
public class GetAllReviewsOdUserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<GetReviewDTO> userReviewsDTOList = reviewServices.findAllReviewOfUser(userDTO.getUserId());

...
public class Message {
    ...
    public static class User {
        ...
        public static final String INVALID_PASSWORD = "The password you entered is invalid. Please enter valid one, " +
                                                    "it should be between 8-40 characters and should be a " +
        ...
        public static final String INVALID_USER = "There is no user registered by this email. Please register first to access " +
                                                "the application";
